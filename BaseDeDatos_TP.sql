...
INSERT INTO `bloque` VALUES (1,1,1,NULL),(2,2,1,NULL),(3,3,1,1),(4,1,2,NULL),(5,2,2,NULL),(6,3,2,1),(7,1,3,NULL),(8,2,3,NULL),(9,3,3,NULL),(10,4,3,NULL),(11,5,3,NULL),(12,6,3,1);
...
INSERT INTO `instrucciones de sistema` VALUES (1,5,60,60,4,'INSTRUCCIONES: @@1) Presione ?Aceptar? luego de haber le?do estas instrucciones para dar comienzo a su evaluaci?n. @Despu?s de esto se les presentara en la pantalla un bloque con preguntas, y se dar? inicio a su evaluaci?n. @@2) Lea atentamente las preguntas y conteste una solo opci?n por cada una. @Recuerde que solo pude haber una sola opci?n contestada y no podr? dejar una pregunta sin su correspondiente respuesta. @@3) Verifique sus respuestas antes de presionar ?siguiente?. @No podr? volver a ver el bloque de preguntas una vez pasado al siguiente bloque. @@4) Recuerde que tiene un l?mite de accesos a realizar el cuestionario. M?ximo de accesos es?');
...
-- Dump completed on 2012-01-17 18:16:26
